    ...
    <PageContent>
      <div>
        <form className="flex flex-col gap-4 rounded-lg bg-slate-800 p-10" onSubmit={handleFormSubmit}>
          ...
          <button type="submit" disabled={buttonDisabled} className="btn-outline btn mt-5 w-full rounded-lg border-2 border-blue-500 text-slate-300 hover:border-blue-500 hover:bg-blue-600 hover:text-slate-50">
            Edit Contact
          </button>
        </form>
      </div>
