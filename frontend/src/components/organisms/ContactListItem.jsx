...
export const ContactListItem = ({ id, type, title, content, updatedAt, createdAt }) => {
  ...
  return (
    <div className="mb-4 flex w-full items-center">
      ...
      <button className="btn-sm btn -ml-24 border-2 border-blue-800 bg-slate-800 text-xs text-slate-300 hover:bg-rose-600 hover:text-rose-50" onClick={handleContactDelete}>
        Delete
      </button>
    </div>
  );
